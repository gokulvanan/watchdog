...
module.exports = function(){
    ...
    function instantiateChild(val,key,config){
        ...
        var child =  iris.child({
            ...
            onError : function(err){
                console.log(key+" error: "+err.stack);
            },
            onExit : function (code,signal){
                console.log(key+" exit : "+signal);
            }
        });
